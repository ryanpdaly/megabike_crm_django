...
class NotificationsMixin(ContextMixin):
	def get_context_data(self, *args, **kwargs):
		...
		data['contact_open_list'] = contact_models.PhoneContact.objects.filter(status='offen')
 
		data['insurance_open_list'] = self.get_open_insurance_tickets()

		data['warranty_open_list'] = self.get_open_warranty_tickets()

		return data

	def get_open_insurance_tickets(self):
	...
	def get_open_warranty_tickets(self):
